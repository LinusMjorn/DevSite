...
const FeedbackCard = ({index, testimonial, name, designation, company, image} ) => (
  ...
  <motion.div variants={fadeIn("","spring", index*0.5, 0.75)} className='bg-black-200 p-10 rounded-3xl xs:w-[320px] w-full '>
    <p className='text-white font-sans text-[48px]'>"</p>
    <div className='mt-1'>
    ...
    <div className='mt-12 bg-tertiary rounded-[20px]'>
      <div className={`${styles.padding} bg-tertiary rounded-2xl min-h-[300px]`}>
        <motion.div variants={textVariant()}>
          <p className={styles.sectionSuvbText}>What do people say about me?</p>
          <h1 className={styles.sectionHeadText}>Feedback:</h1>
        </motion.div>
      </div>
